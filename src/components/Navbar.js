...
const Navbar = ({selectedSub, handleMenuChange, handleRefreshClick}) => (
    <div style={{ margin: '1rem' }}>
        <Menu pointing secondary>
            ...
            <Menu.Item name='programmer humor' active={selectedSub === 'programmerhumor'} onClick={handleMenuChange} />
            <Menu.Item name='learn programming' active={selectedSub === 'learnprogramming'} onClick={handleMenuChange} />
            <Menu.Item name='web design' active={selectedSub === 'web_design'} onClick={handleMenuChange} />
            <Menu.Menu position='right'>
                <Menu.Item onClick={() => handleRefreshClick()}><Icon name='refresh' /></Menu.Item>
                <Menu.Item href="http://github.com/MJPeppersdev/" target="_blank"><Icon name='github' size="large" /></Menu.Item>
            </Menu.Menu>
        </Menu>
    </div>
)
